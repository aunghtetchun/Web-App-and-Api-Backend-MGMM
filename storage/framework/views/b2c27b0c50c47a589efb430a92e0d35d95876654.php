<?php $__env->startSection("title"); ?> Crawl Game List <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent("component.breadcrumb",["data"=>[
        ...
        <?php $__env->slot("last"); ?> Crawl Game List <?php $__env->endSlot(); ?>
    ...
    <div class="row">
        <div class="col-12">
            <?php $__env->startComponent("component.card"); ?>
                ...
                <?php $__env->slot('title'); ?> Crawl Game List <?php $__env->endSlot(); ?>
                <?php $__env->slot('button'); ?>
                    <a href="<?php echo e(route('scraper.updateGame')); ?>" class="btn btn-sm btn-danger">
                        <i class="fas fa-arrow-up fa-fw"></i> Update All
                    </a>
                        <a href="<?php echo e(route('scraper.addGame')); ?>" class="btn btn-sm btn-outline-primary">
                                ...
                                <tr >
                                    ...
                                    <td >
                                        <div class="d-inline-flex">
                                            <img class="rounded mr-2 border border-danger" src="<?php echo e($p->logo); ?>" alt="" style="width: 45px;">
                                    ...
                                    <td>
                                        <p class="badge badge-pill badge-success p-2"><?php echo e($p->getUser? $p->getUser->name: 'Unknown'); ?></p>
                                    </td>
                                    <td>
                                        <div class="d-inline-flex">
...
<?php echo $__env->make('dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/modgamesmm/resources/views/crawler/index.blade.php ENDPATH**/ ?>