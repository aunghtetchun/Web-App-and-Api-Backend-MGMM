...
<?php $__env->startSection('content'); ?>
    <div class="container mb-5 py-2 px-3">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to MGMM.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to MGMM, accessible from <a href="https://www.modgamesmm.com"
                        rel="external nofollow noopener" target="_blank">https://www.modgamesmm.com</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>By email: importent.aa@gmail.com</p>
            </li>
            <li>
                <p>By visiting this page on our website: <a href="https://www.facebook.com/modgamesmyanmar"
                        rel="external nofollow noopener" target="_blank">https://www.facebook.com/modgamesmyanmar</a></p>
            </li>
            <li>
                <p>By phone number: +959971404793</p>
            </li>
        </ul>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('dashboard.game_ui', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/modgamesmm/resources/views/privacy-policy.blade.php ENDPATH**/ ?>