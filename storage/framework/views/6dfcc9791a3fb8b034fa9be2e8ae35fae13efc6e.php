...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group">
                                        <label for="tag_id">Category
                                            ...
                                            <?php $__currentLoopData = \App\Post_category::where('post_id',$post->id)->get('category_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="badge px-2 badge-pill badge-primary"><?php echo e($c->getCat->title); ?></span>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="link1" id="link1" value="<?php echo e($post->link1); ?>" placeholder="Link One">
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php if ($errors->has('link2')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('link2'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="link2" id="link2" value="<?php echo e($post->link2); ?>" placeholder="Link Two">
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php if ($errors->has('link3')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('link3'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="link3" id="link3" value="<?php echo e($post->link3); ?>" placeholder="Link Three">
...
<?php echo $__env->make('dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/modgamesmm/resources/views/popular/edit.blade.php ENDPATH**/ ?>