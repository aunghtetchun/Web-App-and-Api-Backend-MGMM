    ...
    <div class="container pt-5 px-2">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-10 col-md-5 col-lg-4 py-2 px-1">
                <div class="card shadow">
                    <img class="card-img-top mx-auto rounded-circle"
                    src="<?php echo e(asset('dashboard/images/profile_default.png')); ?>"
                    alt="Card image cap">
                    <div class="card-body pt-1 text-center">
...
<?php echo $__env->make('dashboard.game_ui', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/modgamesmm/resources/views/ad_accept.blade.php ENDPATH**/ ?>