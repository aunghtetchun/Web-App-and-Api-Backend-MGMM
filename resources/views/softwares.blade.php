    ...
    <div class="container py-4"  >
        <div class="col-12 p-0 d-flex flex-wrap align-items-stretch">
            <div class="col-12 d-flex flex-wrap justify-content-around align-items-center" style="height: 20vh">
                <form class="text-white w-100" action="{{ route('software.softwareSearch') }}" method="get" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-row align-items-end justify-content-center">
                        <div class="form-group col-md-5">
                            <label for="name" class="h5 mb-3 text-dark font-weight-bold">Search Software</label>
                            <input required type="text" class="form-control rounded-0 @error('name') is-invalid @enderror" name="name" id="name" value="{{old('name')}}" placeholder="နာမည်အစစာလုံးကိုသာရေးပါ">
                        </div>
            ...
            <div class="col-12 my-5 text-center px-0 py-3 text-dark" style="background: whitesmoke;">
                <p class="px-lg-5" style="line-height: 6vw; font-size: 4vw" >!! Opp There is nothing software here.... <a href="{{route('software.softwareList')}}" class="badge px-4 badge-pill badge-primary">Back</a></p>
                <hr/>
