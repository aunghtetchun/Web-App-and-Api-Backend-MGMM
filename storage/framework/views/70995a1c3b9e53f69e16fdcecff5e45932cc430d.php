<?php $__env->startSection("title"); ?> Software List <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent("component.breadcrumb",["data"=>[
        ...
        <?php $__env->slot("last"); ?> Software List <?php $__env->endSlot(); ?>
    ...
    <div class="row">
        <div class="col-12">
            <?php $__env->startComponent("component.card"); ?>
                ...
                <?php $__env->slot('title'); ?> Software List <?php $__env->endSlot(); ?>
                <?php $__env->slot('button'); ?>
                    <a href="<?php echo e(route('software.index')); ?>" class="btn btn-sm btn-outline-primary">
                        <i class="fas fa-list fa-fw"></i> All
                    </a>
                        
                        <a href="<?php echo e(route('software.create')); ?>" class="btn btn-sm btn-outline-primary">
                ...
                <?php $__env->slot('body'); ?>
                    <div class="table-responsive">
                        <table class="table  table-hover mb-0 table-hover">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $softwares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr >
                                    <th scope="row"><?php echo e($p->id); ?></th>
                                    <td >
                                        <div class="d-inline-flex">
                                            <img class="rounded mr-2 border border-danger" src="<?php echo e(asset("/storage/slogo/".$p->logo)); ?>" alt="" style="width: 45px;">
                                    ...
                                    <td>
                                        <div class="d-inline-flex">
                                            ...
                                            <a target="" href="<?php echo e(route('software.edit',$p->id)); ?>" class="btn mr-2 btn-outline-warning btn-sm">
                                                <i class="feather-edit"></i>
                                            </a>
                                            <form action="<?php echo e(route('software.destroy',$p->id)); ?>"  method="post">
                                               <?php echo csrf_field(); ?>
                                            ...
                                            <?php endif; ?>
                                            <a target="_blank" href="<?php echo e(route('software.show',$p->id)); ?>" class="btn ml-2 btn-outline-success btn-sm">
...
<?php echo $__env->make('dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/modgamesmm/resources/views/software/index.blade.php ENDPATH**/ ?>