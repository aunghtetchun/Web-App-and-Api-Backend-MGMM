...
<head>
    ...
    <link href="{{ asset('dashboard/vendor/multi_img_up/dist/image-uploader.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('dashboard/vendor/chart_js/Chart.css') }}" rel="stylesheet" />
...
<!-- Scripts -->
    ...
    <script src="{{ asset('dashboard/vendor/multi_img_up/dist/image-uploader.min.js') }}"></script>
    <script src="{{ asset('dashboard/vendor/chart_js/Chart.js') }}"></script>
    <script src="{{ asset('dashboard/vendor/chart_js/Chart.bundle.js') }}"></script>
    <script>
