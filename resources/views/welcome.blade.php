    ...
    <div class="container">
        <div class="col-12 p-0 pt-2 d-flex flex-wrap align-items-center">
                ...
                <div class="col-12 px-1 px-md-2 px-lg-3 col-md-6 col-lg-4 my-2">
                    <div class="col-12 rounded p-0 bg-light d-flex flex-wrap align-items-center game_card "
                        ...
                        <div class="col-9 p-0 pr-1 text-center card-body pt-1 "
                            onclick="location.href='{{ route('game.singleGameList', $post->slug) }}'" style="padding: 13px">
                            <p class="card-title w-100 mb-0 "
                                style="font-size: 14px; color:black; overflow:hidden; height:20px;">{{ $post->name }}</p>
                            ...
                            <h6 class="text-center m-0 p-0 list_badge badge badge-success px-2 py-1" style="top: 30%;"><i
                                    class="feather-eye "></i> {{ $post->count }}</h6>
                            @if ($post->new == 1)
            ...
            <div class="col-12 text-center my-3">
                <a href="{{ route('game.gameList') }}" class="btn px-4  text-light font-weight-bold py-2 rounded-0"
            ...
            @foreach (App\Software::latest()->limit(12)->inRandomOrder()->get() as $post)
                <div class="col-12 px-1 px-md-2 px-lg-3 col-md-6 col-lg-4 my-2">
                    <div class="col-12 rounded p-0 bg-light d-flex flex-wrap align-items-center game_card "
                        ...
                        <div class="col-3 pl-2 pr-2 py-2 rounded">
                            <img class="p-0  px-0 pt-0 cropped" src="{{ asset('/storage/slogo/' . $post->logo) }}"
                                alt="Card image cap"
                                onclick="location.href='{{ route('software.singleSoftwareList', $post->slug) }}'"
                                style="border-radius:0.5rem!important; ">
                        </div>
                        <div class="col-9 p-0 pr-1 text-center card-body pt-1 "
                            onclick="location.href='{{ route('software.singleSoftwareList', $post->slug) }}'"
                            style="padding: 13px">
                            <p class="card-title w-100 mb-0 "
                                style="font-size: 14px; color:black; overflow:hidden; height:20px;">{{ $post->name }}
                            </p>
                            <div class="star" style="color:#ffe100 !important;">
                                @for ($i = 1; $i <= 5; $i++)
                                    @if ($i <= $post->rating)
                ...
                @endif --}}
                        ...
                        <!-- <div class="col-12 p-0 pt-2">
                            <img class="w-100 rounded" src="{{ asset('/storage/post/') }}" alt="" style="border-radius:0.8rem!important;">
            ...
            <div class="col-12 text-center mt-4">
                <a href="{{ route('software.softwareList') }}"
