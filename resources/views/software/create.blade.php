...
@section("title") Add Software @endsection
...
@section('content')
    ...
    @component("component.breadcrumb",["data"=>[
        ...
        @slot("last") Add Software @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-12 col-xl-10">
            @component("component.card")
                ...
                @slot('title') Add Software @endslot
                @slot('button')
                            ...
                            <div class="form-row justify-content-between ">
                                <div class="form-group col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{old('name')}}" placeholder="Software Name">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name_2') is-invalid @enderror" name="name_2" id="name_2" value="Download Obb" placeholder="Download Obb">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name_3') is-invalid @enderror" name="name_3" id="name_3" value="Download Original Apk" placeholder="Download Original Apk">
