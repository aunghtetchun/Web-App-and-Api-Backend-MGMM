                ...
                <div class="col-12 px-1 px-md-2 px-lg-3 col-md-6 col-lg-4 my-2">
                    <div class="col-12 rounded p-0 bg-light d-flex flex-wrap align-items-center game_card "  style="cursor: pointer; border-radius:0.5rem!important;box-shadow: rgba(0, 0, 0, 0.25) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.25) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset; ">
                        ...
                        <div class="col-3 pl-2 pr-2 py-2 rounded">
                            <img class="p-0  px-0 pt-0 cropped" src="<?php echo e(asset("/storage/logo/".$post->logo)); ?>" alt="Card image cap" onclick="location.href='<?php echo e(route('game.singleGameList',$post->slug)); ?>'" style="border-radius:0.5rem!important; ">
                        </div>
                        <div class="col-9 p-0 pr-1 text-center card-body pt-1 " onclick="location.href='<?php echo e(route('game.singleGameList',$post->slug)); ?>'" style="padding: 13px">
                            ...
                            <h6 class="text-center m-0 p-0 list_badge badge badge-success px-2 py-1" style="top: 30%;"><i class="feather-eye "></i>  <?php echo e($post->count); ?></h6>
                            <?php if($post->new==1): ?>
...
<form class="text-white w-100 mx-1 mt-2 mb-0" action="<?php echo e(route('software.softwareSearch')); ?>" method="get" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="form-row align-items-end justify-content-center">
        <div class="form-group col-10 col-md-5 pr-0">
    ...
    <div class="col-12 px-1 px-md-2 px-lg-3 col-md-6 col-lg-4 my-2">
        <div class="col-12 rounded p-0 bg-light d-flex flex-wrap align-items-center game_card "  style="cursor: pointer; border-radius:0.5rem!important;box-shadow: rgba(0, 0, 0, 0.25) 0px 0.0625em 0.0625em, rgba(0, 0, 0, 0.25) 0px 0.125em 0.5em, rgba(255, 255, 255, 0.1) 0px 0px 0px 1px inset; ">
            ...
            <div class="col-9 p-0 pr-1 text-center card-body pt-1 " onclick="location.href='<?php echo e(route('software.singleSoftwareList',$post->slug)); ?>'" style="padding: 13px">
                ...
                <h6 class="text-center m-0 p-0  badge badge-success px-1 py-1" style="position:absolute; min-width:55px; top: 30%; right:0; font-size: 12px"><i class="feather-eye"></i> &nbsp; <?php echo e($post->count); ?></h6>               
...
<div class="col-12 text-center mt-4">
    <a href="<?php echo e(route('software.softwareList')); ?>" class="btn px-4  text-light font-weight-bold py-2 rounded-0" style="background-color: #a81d1d;"> See More <i class="feather-arrow-right"></i></a>
</div>
