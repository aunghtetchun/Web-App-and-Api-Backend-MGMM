...
{{--                                        {{ $post->category_id == $c->id ? "selected":"" }}--}}
                                    ...
                                    <div class="form-group">
                                        <!--<label for="link3">Download Apk</label>-->
                                         <input type="text" class="form-control @error('name_1') is-invalid @enderror" name="name_1" id="name_1" value="{{ $post->name_1 }}" placeholder="d">
                                        
                                        <input type="text" class="form-control mt-1 @error('link1') is-invalid @enderror" name="link1" id="link1" value="{{ $post->link1 }}" placeholder="မထည့်လည်းရပါတယ်">
                                        @error('link1')
                                        <small class="invalid-feedback font-weight-bold" role="alert">
                                            {{ $message }}
                                        </small>
                                    ...
                                    <div class="form-group">
                                        <!--<label for="link2">Download Obb</label>-->
                                         <input type="text" class="form-control @error('name_2') is-invalid @enderror" name="name_2" id="name_2" value="{{ $post->name_2 }}" placeholder="d">
                                        
                                        <input type="text" class="form-control mt-1 @error('link2') is-invalid @enderror" name="link2" id="link2" value="{{ $post->link2 }}" placeholder="မရှိရင်ထည့်စရာမလိုပါ">
                                        @error('link2')
                                        <small class="invalid-feedback font-weight-bold" role="alert">
                                            {{ $message }}
                                        </small>
                                    ...
                                    <div class="form-group">
                                        <!--<label for="link3">Download Apk</label>-->
                                         <input type="text" class="form-control @error('name_3') is-invalid @enderror" name="name_3" id="name_3" value="{{ $post->name_3 }}" placeholder="d">
                                        
                                        <input type="text" class="form-control mt-1 @error('link3') is-invalid @enderror" name="link3" id="link3" value="{{ $post->link3 }}" placeholder="မထည့်လည်းရပါတယ်">
                                        @error('link3')
                                        <small class="invalid-feedback font-weight-bold" role="alert">
                                            {{ $message }}
                                        </small>
