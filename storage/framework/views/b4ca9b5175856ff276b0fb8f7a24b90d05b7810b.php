                ...
                <?php $__env->slot('body'); ?>
                    <div>
                        <table class="table table-bordered table-hover table-responsive-sm table-responsive-md mb-0">
                            ...
                            <tbody>
                            <?php $__currentLoopData = \App\Rating::latest()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th scope="row"><?php echo e($r->id); ?></th>
                                    <td>
                                        <img src="<?php echo e(asset("/storage/logo/".$r->getPost->logo)); ?>" alt="" style="width: 40px;">
                                    </td>
                                    <td><?php echo e($r->getPost->name); ?></td>
                                    <td>
...
<?php echo $__env->make('dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/modgamesmm/resources/views/rating/index.blade.php ENDPATH**/ ?>