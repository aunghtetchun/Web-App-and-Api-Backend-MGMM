                        ...
                        <form action="{{ route('account.update',$account->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            @method('PUT')
                                    ...
                                    <div class="form-group justify-content-center align-items-center">
                                        ...
                                        <input  type="file" accept="image/png, .jpeg, .jpg,image/webp, image/gif" class="form-control d-none  p-1 @error('profile') is-invalid @enderror" name="profile" id="profile" value="{{old('profile')}}" onchange="readURL(this);">
                                        @error('profile')
                                        <small class="invalid-feedback font-weight-bold" role="alert">
                                            {{ $message }}
                                        </small>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control @error('description') is-invalid @enderror" name="description" id="description" value="{{$account->description}}" placeholder="">
                                        @error('description')
                                        <small class="invalid-feedback font-weight-bold" role="alert">
                                            {{ $message }}
                                        </small>
