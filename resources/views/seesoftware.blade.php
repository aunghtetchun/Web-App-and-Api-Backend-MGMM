...
@section('og_image'){{ asset('storage/software/' . $photo->name) }}@endsection
@break
@endforeach
{{-- @section('og_image'){{ asset('storage/slogo/' .$software->logo)}}@endsection --}}
@section('twt_image'){{ asset('storage/slogo/' .$software->logo)}}@endsection
@section('meta_icon'){{ asset('storage/slogo/' .$software->logo)}}@endsection
@section('lg_logo'){{ asset('storage/slogo/' .$software->logo)}}@endsection
