<?php $__env->startSection("title"); ?> Add Ads <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent("component.breadcrumb",["data"=>[
        ...
        <?php $__env->slot("last"); ?> Add Ads <?php $__env->endSlot(); ?>
    ...
    <div class="row">
        <div class="col-12 col-xl-6">
            <?php $__env->startComponent("component.card"); ?>
                ...
                <?php $__env->slot('title'); ?> Add Ads <?php $__env->endSlot(); ?>
...
endif; ?>" name="link" id="link" value="<?php echo e(old('link')); ?>" placeholder="Ads Name">
...
if (isset($messageCache)) { $message = $messageCache; }
                                ...
                                <div class="form-group justify-content-center align-items-center">
                                    ...
                                    <input  required type="file" accept="image/png, .jpeg, .jpg, image/gif" class="form-control d-none  p-1 <?php if ($errors->has('photo')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
                                    ...
                                    <img id="blah" onclick="$('#photo').trigger('click');" class="w-100 rounded" src="<?php echo e(asset('dashboard/images/upload.png')); ?>" alt="your image" />
                                </div>
...
<?php echo $__env->make('dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/modgamesmm/resources/views/ads/create.blade.php ENDPATH**/ ?>