...
<head>
    <meta charset="UTF-8">
    <!-- Primary Meta Tags -->
    <meta name="title" content="@yield('meta_gtitle','Welcome from Mod games myanmar.')">
    <meta name="description" content="@yield('meta_gdescription','Welcome from Mod games myanmar. You can download all mod games here.')">
    <meta name="keywords" content="@yield('meta_gkeywords','modgamesmm,mgmm, MGMM')">
    ...
    <meta property="og:image" content="@yield('og_image', asset(\App\Custom::$info['c-logo']) )">
    <!-- Twitter -->
    ...
    <meta property="twitter:image" content="@yield('twt_image', asset(\App\Custom::$info['c-logo']) )">
    ...
    <!-- Google Meta  -->
    <meta name="google-site-verification" content="tV4JNlHV7FhVOt1yAX2t7FxwRIqpKHa6GaFwGizQa_4" />
    ...
    <script type="application/ld+json">
        {
            ...
            "name": "MGMM",
            "url": "https://modgamesmm.com",
            "logo": "@yield('lg_logo', asset(\App\Custom::$info['c-logo']) )",
            "sameAs": [
    ...
    <link rel="icon" href="@yield('meta_icon',asset(\App\Custom::$info['c-logo']) )">
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7297781591471758"
     ...
     <script async src="https://fundingchoicesmessages.google.com/i/pub-7297781591471758?ers=1" nonce="YOqT9kQHmHXipGXtomja6g"></script><script nonce="YOqT9kQHmHXipGXtomja6g">(function() {function signalGooglefcPresent() {if (!window.frames['googlefcPresent']) {if (document.body) {const iframe = document.createElement('iframe'); iframe.style = 'width: 0; height: 0; border: none; z-index: -1000; left: -1000px; top: -1000px;'; iframe.style.display = 'none'; iframe.name = 'googlefcPresent'; document.body.appendChild(iframe);} else {setTimeout(signalGooglefcPresent, 0);}}}signalGooglefcPresent();})();</script>
     <script>(function(){/*
...
<div class="container-fluid" style="background:  #f7efe9">
    <div class="row">
        ...
        <div class="col-12 p-0 position-sticky" style=" top: 0; z-index: 16; background: #a81d1d">
            <div class="container ">
                <div class="row">
                    <div class="col-12 p-0 nbar ">
                        <nav class="navbar py-0 navbar-expand-sm navbar-dark " style="background: #a81d1d !important;">
                            <label class="logo px-0" onclick="location.href='{{route('game.gameList')}}'"  style="cursor: pointer">
                                <img src="{{ asset(\App\Custom::$info['c-logo']) }}"  style="width: 65px; filter:drop-shadow(0px 0px 6px white) !important;">
                            </label>
                            <span class="h3 pl-2 text-white gsmm" onclick="location.href='{{route('game.gameList')}}'"  style="cursor: pointer">MGMM</span>
                            <a class="btn eighteen btn-success px-3 ml-md-2 rounded-0 py-3 font-weight-bold" style="font-size:19px; position: fixed;
    
    width: 100%;
    bottom: 0;
    right: 0;
    background: #a81d1d !important;" href="{{ route('game.gameListFilter',10) }}">
                                            <i class="fas fa-arrow-right mr-1"></i> 18+ Games List <i class="fas ml-1 fa-arrow-left"></i>
                                        </a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link " href="#" id="navbarDropdown" role="button" data-toggle="modal" data-target="#catmodal">
                                            Games
                                        </a>
                                        <!-- Modal -->
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Games List</h5>
                                        ...
                                        <div class="modal-body" style="z-index:3000;">
                                            ...
                                            <a class="btn btn-outline-primary px-3 py-2 m-2" href="{{ route('game.gameList') }}" role="button">All Games List</a>
                                            @foreach(\App\Category::all() as $cat)
                                            <a style="min-width:44%;" class="btn btn-outline-primary px-3 py-2 m-2" href="{{ route('game.gameListFilter',$cat->id) }}" role="button">{{ $cat->title}}</a>
                                            @endforeach
                                            </div>
                                        </div>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link "  href="{{ asset('/softwares') }}">Software</a>
                                    </li>
                                    <!-- <li class="nav-item">
                                        <a class="nav-link " href="{{ route('game.gameListFilter',10) }}">18+ ဂိမ်းများကြည့်ရန်</a>
                                    </li> -->
                                    <!-- <li class="nav-item">
                                        <a class="nav-link " href="https://www.facebook.com/permalink.php?story_fbid=pfbid0XBLsQJz1A6drMxHdceAqGoQ1fokSyW54vFnHAnZXUQYe5qjcqJPLvvn4dfE5BJrPl&id=100059336683324">How To Download</a>
                                    </li> -->
                                    <li class="nav-item">
                                        <a class="nav-link " href="{{ route('requestGame.createRequest') }}">ဂိမ်းတောင်းရန်</a>
                                    </li>
                                    <!-- <li class="nav-item">
                                        <a class="nav-link " href="{{ route('suggestGame.createSuggest') }}">Suggest Website</a>
                                    </li> -->
                                    <li class="nav-item">
                                        <a class="nav-link " href="{{ route('adGame') }}">ကြော်ငြာထည့်ရန်</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
        ...
        <div class="content_bod col-12 p-0 bg-light  mb-5" >
            @yield("content")
            ...
            <span class="px-3">Copyright ©2021 All rights reserved | This Website is Created  by <a href="https://www.facebook.com/aunghtetch0n">Aung Htet Chon</a>
            </span>
            </div>
        </div>
