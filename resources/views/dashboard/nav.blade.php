@auth
    <div class="aside-left bg-white px-3 pb-2 min-vh-100 shadow">
        <ul class="menu" style="list-style-type: none">
            ...
            @component("component.nav-title") Software Management @endcomponent

            @component("component.nav-item")
                @slot("icon") <i class="fas fa-gamepad"></i> @endslot
                @slot("name") Add Software @endslot
                @slot("link") {{ route('software.create') }} @endslot
            @endcomponent

            @component("component.nav-item-count")
                @slot("icon") <i class="feather-list"></i> @endslot
                @slot("name") Software List @endslot
                @slot("link") {{ route('software.index') }} @endslot
                @slot("count") {{ \App\Software::count() }} @endslot
            @endcomponent
            <!-- @component("component.nav-item")
